...
def transform_events(scoreboard_data, rankings_data_list):
    ...
    for event in scoreboard_data["data"]:  
        ...
        home_ranking_details = rankings_data.get(home_team_id, {"rank": "N/A", "rankPoints": "N/A"})
        away_ranking_details = rankings_data.get(away_team_id, {"rank": "N/A", "rankPoints": "N/A"})
